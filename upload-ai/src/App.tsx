        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="transcription_prompt">Prompt de comando</Label>
              <Textarea
                id="transcription_prompt"
                className="h-20 leading-relaxed"
                placeholder="Inclua palavras chave separadas por virgula" />
            </div>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <span className="block text-xs text-muted-foreground italic">
                Voce poderá customizar estas opções em breve!!!
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <span className="block text-xs text-muted-foreground italic leading-relaxed">
                Valores mais altos tendem a deixar o resultado mais criativo porem suscetível a erros.!!!
              </span>
            </div>
